...
public final class SemanticdbSymbols {
   ...
   *
   * For example, the symbol "com/example/Class#method()." is composed of
   *
   * <ul>
   *     <li>package descriptors "com/" and "example/"</li>
   *     <li>type descriptor "Class/"</li>
   *     <li>method descriptor "method()."</li>
   * </ul>
   *
   */
