 ...
 * </pre>
 *
 * A SemanticDB range has four parts: "startLine", "startCharacter", "endLine",
 * "endCharacter".
 */
public enum CompilerRange {
  ...
  /** Map the compiler point position to SemanticDB start and use (point + symbol name length) for the SemanticDB end position. */
  FROM_POINT_TO_SYMBOL_NAME,

  /** Map the compiler (point + 1) position to SemanticDB start and use (point + symbol name length + 1) for the SemanticDB end position. */
