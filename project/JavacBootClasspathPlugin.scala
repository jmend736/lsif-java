...
///** An sbt plugin that automatically adds */
...
//   * implementation.
//   *
//   * This jar file is available on the boot classpath by default in Java 9+ but
//   * it needs to be manually added to the boot classpath for Java 8.
//   */
